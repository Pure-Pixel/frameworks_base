...
public class VpnTest {
    ...
    static {
        TEST_ROUTES = Collections.unmodifiableList(Arrays.asList(
                new RouteInfo(new IpPrefix("0.0.0.0/0"), null),
                new RouteInfo(new IpPrefix("::/0"), null)));
    ...
    private Vpn connectIkev2Vpn() throws Exception {
        final Vpn vpn = startIkev2Vpn();
        ...
        ((ChildSessionCallbackImpl) childCb).onOpened(
                TEST_NETWORK, TEST_LINK_ADDRESSES, TEST_ROUTES);
    ...
    public void testStartLegacyVpn() throws Exception {
        ...
        final RouteInfo defaultRoute = new RouteInfo(
                new IpPrefix(Inet4Address.ANY, 0), InetAddresses.parseNumericAddress("192.0.2.0"),
                egressIface);
