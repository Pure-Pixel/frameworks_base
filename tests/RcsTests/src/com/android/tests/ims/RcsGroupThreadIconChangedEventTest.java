...
public class RcsGroupThreadIconChangedEventTest {
    ...
    public void testCanUnparcel() {
        RcsGroupThread rcsGroupThread = new RcsGroupThread(1, null, null,
                Uri.parse("content://icon"), null);
        ...
        RcsGroupThreadIconChangedEvent iconChangedEvent =
                new RcsGroupThreadIconChangedEvent.Builder(rcsGroupThread, rcsParticipant)
                        .setNewIcon(newIconUri).setTimestamp(1234567890).buildForTest();
