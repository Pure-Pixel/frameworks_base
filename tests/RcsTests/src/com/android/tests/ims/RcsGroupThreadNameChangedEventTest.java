...
public class RcsGroupThreadNameChangedEventTest {
    ...
    public void testCanUnparcel() {
        ...
        RcsGroupThread rcsGroupThread = new RcsGroupThread(1, null, oldName,
        ...
        RcsGroupThreadNameChangedEvent nameChangedEvent =
                new RcsGroupThreadNameChangedEvent.Builder(rcsGroupThread, rcsParticipant)
                        .setNewName(newName).setTimestamp(1234567890).buildForTest();
