...
parcelable AudioHalAttributesGroup {
    /**
     * StreamType may only be set to AudioStreamType.INVALID when the volume
     * group and attributes are not associated to any AudioStreamType; this is
     * only valid when using the Configurable Audio Policy (CAP) engine.
     */
