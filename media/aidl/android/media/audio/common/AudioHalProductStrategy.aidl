...
parcelable AudioHalProductStrategy {
     ...
     */
    const int VENDOR_STRATEGY_TYPE_START = 1000;
    /**
     ...
     * their strategies starting at VENDOR_STRATEGY_TYPE_START.
     */
    int productStrategyType = AudioProductStrategyType.SYS_RESERVED_NONE;
    /**
