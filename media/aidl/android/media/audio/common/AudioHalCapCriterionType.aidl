...
parcelable AudioHalCapCriterionType {
    ...
    boolean isInclusive;
    @VintfStability
    parcelable ValuePair {
        long numerical;
        /**
         * Used to map to numerical bitfield representation of a device
         */
        int androidDeviceType = AudioDeviceType.NONE;
        /**
         * Gives human readable meaning to the numerical value
         */
        @utf8InCpp String literal;
    }
