...
abstract class AndroidKeyStoreRSACipherSpi extends AndroidKeyStoreCipherSpiBase {
    ...
    abstract static class OAEPWithMGF1Padding extends AndroidKeyStoreRSACipherSpi {
        ...
        // Only allow the KM_TAG_RSA_OAEP_MGF_DIGEST tag to begin() if the MGF Digest is
        // present in the key properties or KeyMint version is 100 or 200. Keys generated or
        // imported prior to Android 14 did not have this tag (Keystore didn't add it),
        // so specifying any MGF digest tag would cause a begin() operation (on an Android 14
        // device) to fail (with a key that was generated on Android 13 or below).
        private static boolean shouldMgfDigestInclude(
                Authorization[] keyCharacteristics) {
            boolean isMgfDigestPresent = false;
            ...
            return isMgfDigestPresent || isSecurityLevelV1OrV2;
        }
