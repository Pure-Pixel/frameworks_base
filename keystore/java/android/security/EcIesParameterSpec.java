...
/**
 * {@link AlgorithmParameterSpec} for EC-IES (Integrated Encryption Scheme using Elliptic Curve
 * cryptography).
 *
 * <p>EC-IES is an hybrid authenticated encryption scheme. Encryption is performed using an Elliptic
 ...
 *
 * <p>Encryption using EC-IES consists of two stages:
 * <ol>
...
public class EcIesParameterSpec implements AlgorithmParameterSpec {
    ...
    public static abstract class PointFormat {
         ...
         * {@code x} coordinate followed by binary representation of the {@code y} coordinate.
         */
    ...
    /**
     * Returns the name of DEM (e.g., {@code DEM1}) or {@code null} if not specified.
     */
    ...
    /**
     * Returns DEM {@link Cipher} key size in bits or {@code -1} if not specified.
     *
    ...
    /**
     * Returns DEM {@link Mac} key size in bits {@code -1} if not specified.
     */
    ...
    public static class Builder {
        ...
        private String mDemName;
        private String mDemCipherTransformation;
        private int mDemCipherKeySize = -1;
        private String mDemMacAlgorithm;
        private int mDemMacKeySize = -1;

        /**
         * Sets KEM EC curve name. For example, {@code secp256r1} or {@code P-256}.
         */
        ...
        /**
         * Sets KEM KDF algorithm. For example, {@code HKDFwithSHA256} or {@code KDF1withSHA1}.
         */
        ...
        /**
         * Sets the name of DEM. For example, {@code DEM1}.
         */
        public Builder setDemName(String name) {
            mDemName = name;
            return this;
        }
