...
public class UsageStatsService extends SystemService implements
    ...
    // file by reading it from here if needed, and always writing it to the new path.  Note,
    // system_server can't delete this old directory as it no longer has permission to do so.
    private static final File LEGACY_COMMON_USAGE_STATS_DIR = new File(
            Environment.getDataSystemDeDirectory(), "usagestats");
