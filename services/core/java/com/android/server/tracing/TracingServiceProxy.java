...
public class TracingServiceProxy extends SystemService {
    ...
    private void reportTrace(
        ...
        reporterService.post(messenger -> {
            // Verify that this service actually requests the BIND_TRACE_REPORT_SERVICE
            // permission.
            checkRequestsBindPermissionOrThrow(componentName);
    ...
    private void checkRequestsBindPermissionOrThrow(@NonNull ComponentName componentName)
            throws NameNotFoundException, SecurityException {
        ServiceInfo info = mPackageManager.getServiceInfo(componentName,
