...
public class GestureLauncherService extends SystemService {
    ...
    private final class GestureBinderService extends IGestureLauncher.Stub {
        ...
        public boolean isCameraButtonLaunchSettingEnabled() {
            final long ident = Binder.clearCallingIdentity();
            try {
                //return isCameraButtonLaunchSettingEnabled(
        ...
        /*
        @Override // Binder call
        public boolean handleCameraGesture(
                boolean useWakeLock, int launchSource) {
            final long ident = Binder.clearCallingIdentity();
            try {
                return handleCameraGesture(
                        useWakeLock, launchSource);
            } finally {
                Binder.restoreCallingIdentity(ident);
            }
        }
