 ...
 */
public class AppHibernationService extends SystemService {
    ...
    /**
     * Set package hibernation state for a given user.
     *
     * @param packageName package to modify state
     * @param isHibernating new hibernation state
     * @param userId user
     */
    public void setHibernationState(String packageName, boolean isHibernating, int userId) {
        // Stub
        throw new UnsupportedOperationException("Hibernation state management not implemented yet");
    }
    ...
    static class AppHibernationServiceStub extends IAppHibernationService.Stub {
        AppHibernationService mService;
        ...
        @Override
        public void setHibernationState(String packageName, boolean isHibernating, int userId) {
            mService.setHibernationState(packageName, isHibernating, userId);
        }
    }
