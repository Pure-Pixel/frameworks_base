...
public class NetdUnsolicitedEventListenerService extends INetdUnsolicitedEventListener.Stub {
    ...
    public synchronized boolean addNetdUnsolicitedEventCallback(int callerType, INetdUnsolicitedEventCallback callback) {
    ...
    @Override
    public synchronized void onInterfaceClassActivityEvent(boolean isActive, String name, long timestamp , int uid)
    ...
    @Override
    public synchronized void onInterfaceDnsServersEvent(String ifName, long lifetime, String[] servers)
            throws RemoteException {
        for (INetdUnsolicitedEventCallback callback : mNetdEventCallbackList) {
            if (callback != null) {
    ...
    @Override
    public synchronized void onInterfaceAddressChangeEvent(boolean updated, String addr, String ifName, int flags, int scope)
            throws RemoteException {
        for (INetdUnsolicitedEventCallback callback : mNetdEventCallbackList) {
            if (callback != null) {
    ...
    @Override
    public synchronized void onRouteChangeEvent(boolean updated, String route, String gateway, String ifName)
            throws RemoteException {
        for (INetdUnsolicitedEventCallback callback : mNetdEventCallbackList) {
            if (callback != null) {
