 ...
 *
 * <p>When available, t he time is always suggested to the {@link
 * com.android.server.timedetector.TimeDetectorService} where it may or may not be used to set the
 * device system clock, depending on user settings and what other signals are available.
 */
