...
/**
 * A class that behaves like the following definition, except it stores the history of values it has
 * seen that can be dumped for debugging with {@link #dump(IndentingPrintWriter)}.
 *
 * <pre>{@code
...
public final class ReferenceWithHistory<V> {
    ...
    /**
     * Dumps the content of the reference, including history values, using the supplied writer.
     */
    ...
    /**
     * Returns the number of history entries currently.
     */
