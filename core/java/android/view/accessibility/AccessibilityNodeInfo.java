...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction implements Parcelable {
         ...
         * {@link AccessibilityEvent#TYPE_VIEW_CLICKED} event. In the View system, this is
         * automatically supported in {@link View#performClick()} and
         ...
         * {@link AccessibilityEvent#TYPE_VIEW_LONG_CLICKED} event. In the View system, this is
         * automatically supported in {@link View#performLongClick()} and
         ...
         * {@link AccessibilityEvent#TYPE_VIEW_CONTEXT_CLICKED} event. In the View system, this is
         * automatically supported in {@link View#performContextClick()} and
