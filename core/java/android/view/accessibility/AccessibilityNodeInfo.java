...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction implements Parcelable {
         ...
         * {@link AccessibilityEvent#TYPE_VIEW_CLICKED} event. In the View system, this action calls
         ...
         *
         * <p>The UI element that implements this should send a
         * {@link AccessibilityEvent#TYPE_VIEW_LONG_CLICKED} event. In the View system, this action
         * calls {@link View#performLongClick()}, and setting a
         ...
         * action calls {@link View#performContextClick()}, and setting a
