...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction implements Parcelable {
         ...
         * Action that clicks on the node info.
         *
         * <p>This should call the UI element's click handling which should send a
         * {@link AccessibilityEvent#TYPE_VIEW_CLICKED} event. In the View system, this handling
         * occurs in {@link View#performClick()}, and setting a
         * {@link View#setOnClickListener(View.OnClickListener)} adds this action.
         *
         ...
         * Action that long clicks on the node.
         *
         * <p>This should call the UI element's long click handling which should send a
         * {@link AccessibilityEvent#TYPE_VIEW_LONG_CLICKED} event. In the View system, this
         * handling occurs in {@link View#performLongClick()}, and setting a
         * {@link View#setOnLongClickListener(View.OnLongClickListener)} adds this action.
         *
         ...
         *
         * <p>This should call the UI element's context click handling which should send a
         * {@link AccessibilityEvent#TYPE_VIEW_CONTEXT_CLICKED} event. In the View system, this
         * handling occurs in in {@link View#performContextClick()}, and setting a
         * {@link View#setOnContextClickListener(View.OnContextClickListener)} adds this action.
         *
