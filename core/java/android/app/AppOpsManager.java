...
public class AppOpsManager {
    ...
    /**
     * Allows an application to request a network without specifying a transport.
     *
     * @hide
     */
    ...
    /**
     * Allows an application to request a network that uses a Cellular transport.
     *
     * @hide
     */
    ...
    /**
     * Allows an application to request a network that uses a Wi-Fi transport.
     *
     * @hide
     */
    ...
    /**
     * Allows an application to request a network that uses a Bluetooth transport.
     *
     * @hide
     */
