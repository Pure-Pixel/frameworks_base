...
public final class ApplicationConfig {
    ...
    /**
     * Returns {@code true} cleartext traffic is permitted for this application, which is the case
     * only if all configurations permit cleartext traffic. For finer-grained policy use
    ...
    /**
     * Returns {@code true} cleartext traffic is permitted for this application when connecting to
     * {@code hostname}.
     */
