...
public final class BluetoothGattServer implements BluetoothProfile {
    ...
    private final IBluetoothGattServerCallback mBluetoothGattServerCallback =
        new IBluetoothGattServerCallback.Stub() {
            ...
            public void onCharacteristicReadRequest(String address, int transId,
                ...
                BluetoothGattCharacteristic characteristic = getCharacteristicById(handle);
            ...
            public void onDescriptorReadRequest(String address, int transId,
                ...
                BluetoothDevice device = mAdapter.getRemoteDevice(address);
                BluetoothGattDescriptor descriptor = getDescriptorById(handle);
                if (descriptor == null) {
     ...
     * @hide
     */
    /*package*/ BluetoothGattCharacteristic getCharacteristicById(int instanceId) {
     ...
     * @hide
     */
    /*package*/ BluetoothGattDescriptor getDescriptorById(int instanceId) {
        for(BluetoothGattService svc : mServices) {
            for(BluetoothGattCharacteristic charac : svc.getCharacteristics()) {
