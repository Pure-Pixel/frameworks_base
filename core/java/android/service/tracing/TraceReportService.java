...
public class TraceReportService extends Service {
     ...
     * function as it will be closed immediately after this function returns: if future use of
     * the fd is needed, it should be duped.
     */
    ...
    /**
     * Closes the trace file descriptor. This is called immediately after onReportTrace.
     */
    public void onCloseTraceFd(@NonNull ParcelFileDescriptor fd) {
        try {
            fd.close();
