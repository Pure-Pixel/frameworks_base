...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
    ...
    private static final String NO_CERT_PROVIDED = "";
    ...
    private void validate() {
        ...
        if (mMaxMtu <= LinkProperties.MIN_MTU_V6) {
            throw new IllegalArgumentException("Max MTU must be greater than "
                    + LinkProperties.MIN_MTU_V6);
        }
    ...
    public VpnProfile toVpnProfile() throws IOException, GeneralSecurityException {
        ...
        switch (mType) {
            case TYPE_IKEV2_IPSEC_USER_PASS:
                ...
                profile.ipsecCaCert = mServerRootCaCert == null
                        ? "" : certificateToPemString(mServerRootCaCert);
                break;
            case TYPE_IKEV2_IPSEC_PSK:
    ...
    private static X509Certificate certificateFromPemString(@Nullable String certStr)
        ...
        if (certStr == null || NO_CERT_PROVIDED.equals(certStr)) {
            return null;
        }
    ...
    public static final class Builder {
         ...
         * possible for unprivileged apps to side-step the VPN. If a VPN is set to bypassable via
         * this method is called, apps may use methods such as {@link Network#getSocketFactory} or
         * {@link Network#openConnection} to instead send/receive directly over the underlying
