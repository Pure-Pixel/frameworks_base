...
class VpnDaemons implements Serializable {
    ...
    public DaemonProxy startPptp(String serverIp, String username,
            String password, boolean encryption, String routeList, String excludeRouteList) throws IOException {
    ...
    private DaemonProxy startMtpd(String protocol,
        ...
        addPppArguments(args, serverIp, username, password, encryption, routeList, excludeRouteList);
    ...
    private static void addPppArguments(ArrayList<String> args, String serverIp,
            String username, String password, boolean encryption, String routeList, String excludeRouteList)
            throws IOException {
