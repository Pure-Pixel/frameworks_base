...
public class VolumePanelDialog extends SystemUIDialog implements LifecycleOwner {
    ...
    public VolumePanelDialog(
            Context context, ActivityStarter activityStarter, boolean aboveStatusBar) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View dialogView =
                LayoutInflater.from(getContext()).inflate(R.layout.volume_panel_dialog, null);
    ...
    private void loadAllSlices() {
        ...
        for (Uri uri : sliceUris) {
            final LiveData<Slice> sliceLiveData =
    ...
    private static final Uri REMOTE_MEDIA_SLICE_URI =
            new Uri.Builder()
                    ...
                    .build();
    private static final Uri VOLUME_MEDIA_URI =
            new Uri.Builder()
                    .scheme(ContentResolver.SCHEME_CONTENT)
                    .authority(SETTINGS_SLICE_AUTHORITY)
                    .appendPath(SettingsSlicesContract.PATH_SETTING_ACTION)
                    ...
                    .build();
    private static final Uri MEDIA_OUTPUT_INDICATOR_SLICE_URI =
            new Uri.Builder()
                    .scheme(ContentResolver.SCHEME_CONTENT)
                    .authority(SETTINGS_SLICE_AUTHORITY)
                    ...
                    .build();
    private static final Uri VOLUME_CALL_URI =
            new Uri.Builder()
                    .scheme(ContentResolver.SCHEME_CONTENT)
                    .authority(SETTINGS_SLICE_AUTHORITY)
                    .appendPath(SettingsSlicesContract.PATH_SETTING_ACTION)
                    ...
                    .build();
    private static final Uri VOLUME_RINGER_URI =
            new Uri.Builder()
                    .scheme(ContentResolver.SCHEME_CONTENT)
                    .authority(SETTINGS_SLICE_AUTHORITY)
                    .appendPath(SettingsSlicesContract.PATH_SETTING_ACTION)
                    ...
                    .build();
    private static final Uri VOLUME_ALARM_URI =
            new Uri.Builder()
                    .scheme(ContentResolver.SCHEME_CONTENT)
                    .authority(SETTINGS_SLICE_AUTHORITY)
                    .appendPath(SettingsSlicesContract.PATH_SETTING_ACTION)
    ...
    private Uri getExtraControlUri() {
        ...
        if (bluetoothDevice != null) {
            ...
            final int controlSliceWidth =
                    dialogWidth
                            - getContext()
                                            .getResources()
                                            .getDimensionPixelSize(
                                                    R.dimen.volume_panel_slice_horizontal_padding)
                                    * 2;
