...
#ifndef INCLUSION_GUARD_FWDLOCKENGINE
#define INCLUSION_GUARD_FWDLOCK_ENGINE
 ...
 *
 * @param uniqueId Unique identifier for a session
 * @param path Path the protected object
 * @return bool
 ...
 * and must not the same for different convert sessions.
 *
 * @param uniqueId Unique identifier for a session
...
/**
 * Closes the convert seesion in case of data supply completed or error occured.
 * Upon successful conversion of the complete data, it reutrns signature calculated over
...
#endif /* INCLUSION_GUARD_FWDLOCKENGINE */
