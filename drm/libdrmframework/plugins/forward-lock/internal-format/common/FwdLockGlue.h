...
#ifndef INCLUSION_GUARD_FWDLOCKGLUE
#define INCLUSION_GUARD_FWDLOCKGLUE
...
/**
 * Performs one-time initialization before encryption and decryption of session keys. First creates
 * a device-unique key-encryption key if none exists yet.
 *
 * @return A Boolean value indicating whether the operation was successful.
 */
...
/**
 * Encrypts the given key using a hardware-based key unique to this device.
 *
...
/**
 * Decrypts the given key using a hardware-based key unique to this device.
 *
...
#endif // INCLUSION_GUARD_FWDLOCKGLUE
