...
#ifndef INCLUSION_GUARD_FWDLOCKFILE
#define INCLUSION_GUARD_FWDLOCKFILE
...
/**
 * Attaches to an open Forward Lock file.
 * The file position is assumed to be at the beginning of the file.
 *
...
#endif // INCLUSION_GUARD_FWDLOCKFILE
